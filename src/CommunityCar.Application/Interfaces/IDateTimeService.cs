...
public interface IDateTimeService
{
    ...
    DateTime ConvertFromUtcToTimeZone(DateTime utcDateTime, string timeZoneId);
    DateTime ConvertToUtcFromTimeZone(DateTime localDateTime, string timeZoneId);
    ...
    int GetAge(DateTime birthDate, DateTime atDate);

    // Duration calculations
    TimeSpan GetDuration(DateTime startTime, DateTime endTime);
    string GetHumanReadableDuration(TimeSpan duration);
    string GetTimeAgo(DateTime pastDateTime);
    string GetTimeUntil(DateTime futureDateTime);
